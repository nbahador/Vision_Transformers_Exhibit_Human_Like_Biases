...
output_dir = r"Path_to_model\white_lines_with_varying_angles_lengths_and_widths_fine_tuned_model"
os.makedirs(output_dir, exist_ok=True)
print(f"Output directory set to: {output_dir}")
excel_path = os.path.join(r"Path_to_labels\white_lines_with_varying_angles_lengths_and_widths", "line_labels.xlsx")
...
class LineDataset(Dataset):
    def __init__(self, image_dir, excel_path, max_samples=50000, transform=None):
        ...
        self.df['line_width'] = self.df['line_width'] / 10.0  # Normalize width assuming max width of 10 pixels
...
def main():
    ...
    full_dataset = LineDataset(r"Path_to_Images\white_lines_with_varying_angles_lengths_and_widths", excel_path)
